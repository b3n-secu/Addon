...
DEVICE_PROFILES = {
    "Siemens": {
        ...
        "LOGO! 0BA7": {
            "port": 102,
            "timeout": 5,
            "note": "LOGO! 0BA7 uses S7comm protocol only (Port 102). No native Modbus TCP support.",
            "registers": {
                "digital_inputs": {
                    "type": "binary_sensor",
                    "start_address": 1,
